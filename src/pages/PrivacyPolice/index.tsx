  ...
  return (
    <div>
      <div className="flex flex-col items-start justify-start w-full pl-[120px] pr-14 md:px-5">
        <div className="flex flex-col items-center justify-start w-full gap-[68px] mx-auto max-w-[1054px]">
          <div className="flex flex-col items-center justify-start w-full gap-18">
            ...
            <Text as="p" className="text-lg font-normal leading-[188%]">
              <>
                Hi, welcome to our privacy policy which applies to our
                customers. This policy sets out how if you are a Relasto.com
                user or visitor to our site, we treat your personal information.
                <br />
            ...
            <div className="flex flex-col items-start justify-start w-full pt-0.5 gap-7">
              ...
              <Text as="p" className="text-lg font-normal leading-[180%]">
                <>
                  ...
                  user of the Service, which may be an At Registration, you will
                  select logon credentials for each user of the Service, which
                  may be an employee of the subscriber or other individuals
                  authorised by the subscriber to use the service (Authorised
                  User). Logon details should only be used by the Authorised
                  User to whom they are assigned and cannot be shared with any
                  third parties (including another Authorised User). You are
                  ...
                  details. You shall notify us immediately if you become aware
                  of any loss, theft or unauthorised use of any logon details,
                  and we reserve the right to delete or change them at any time
                  and for any reason.
                  <br />
                  <br />
