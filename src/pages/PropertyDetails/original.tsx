...
//                 <Img
//                   src="../../../public/image/img_rectangle_5610.png"
//                   alt="image"
...
//                 <Img
//                   src="../../../public/image/img_rectangle_5611.png"
//                   alt="image_one"
//                   className="w-full md:h-auto sm:w-full object-cover rounded-[10px]"
//                 />
//                 <div className="h-[263px] w-full relative">
//                   <Img
//                     src="../../../public/image/img_rectangle_5612.png"
//                     alt="image two"
...
//                     leftIcon={
//                       <Img
//                         src="../../../public/image/img_icon_image.svg"
//                         alt="icon image"
//                       />
//                     }
...
//                       size="3x1"
//                       as="h1"
//                       className="tracking-[-0.56px] text-[28px] font-extrabold leading-[135%]"
//                     >
...
//                         size="2x1"
//                         as="h3"
//                         className="ml-[17px] md:ml-8 tracking-[-0.48px] text-2x1 font-bold"
//                       >
//                         $649,900
//                       </Heading>
...
//                         size="xs"
//                         as="h4"
//                         className="ml-[17px] md:ml-01text-gray-600_02 text-xs font-semibold"
//                       >
//                         Online / Cash Payment
//                       </Heading>
//                     </div>
...
//                         size="2x1"
//                         as="h5"
//                         className="ml-[17px] md:ml-0 tracking-[-0.48px] text-2x1 font-bold"
//                       >
//                         $850/ month
//                       </Heading>
//                       <Heading
//                         size="xs"
//                         as="h6"
//                         className="ml-[17px] md:ml-0 !text-gray-600_02 text-xs font-semibold"
//                       >
//                         0% EMI for 6 Months
//                       </Heading>
//                     </div>
...
//                     web page. So, the Elementor slider would be a great tool to
...
//                   size="3x1"
//                   as="h3"
//                   className="mt-[3px] tracking-[-0.56px] text-[28px] font-extrabold"
//                 >
//                   Home Highlights
//                 </Heading>
...
//                         <Text as="p" className="mt-[5px] text-lg font-normal">
//                           Parking
//                         </Text>
//                       </div>
//                       <Heading
//                         size="md"
//                         as="h6"
//                         className="text-right text-1g font-semibold"
//                       >
//                         No Info
//                       </Heading>
//                     </div>
//                     <div className="flex flex-row justify-between items-center w-full">
//                       <div className="flex flex-row justify-start items-center w-[42%] gap-2.5 ру-0.5">
//                         <div className="h-[8px] w-[8px] bg-gray-600_02 rounded-[50%]" />
//                         <Text as="p" className="mt-px text-lg font-normal">
//                           Outdoor
//                         </Text>
//                       </div>
//                       <Heading
...
//                       <Heading
//                         as="h6"
//                         className="mr-1.5 text-base font-semibold"
//                       >
//                         4 review
//                       </Heading>
//                     </div>
...
//                         className="h-[20px] w-[20px]"
//                       />
//                       <Text size="sm" as="p" className="text-base font-medium">
//                         +65 0231 965 965
//                       </Text>
//                     </div>
//                   </div>
...
//                       value="fullname"
//                       label="Full Name"
//                       className="flex w-full pl-3.5 pr-[35px] gap-3.5 py-[17px] text-gray-600_02 text-lg font-semibold  border-blue_gray-100_01 border  border-solid bg-white-A700 rounded-[10px]"
//                     />
//                     <Radio
//                       value="emailaddress"
//                       label="Email Address"
//                       className="flex w-full mt-3 pl-3.5 pr-[35px] gap-3.5 py-[17px] text-gray-600_02 text-lg font-semibold  border-blue_gray-100_01 border  border-solid bg-white-A700 rounded-[10px]"
//                     />
//                     <Radio
//                       value="phonenumber"
//                       label="Phone Number"
...
//                       value="date"
//                       label="Date"
//                       className="flex w-full mt-3 pl-3.5 pr-[35px] gap-3.5 py-[17px] text-gray-600_02 text-1g font-semibold  border-blue_gray-100_01 border  border-solid bg-white-A700 rounded-[10px]"
//                     />
//                   </RadioGroup>
//                   <TextArea
//                     shape="round"
//                     name="inputbox_one"
//                     placeholder="Message"
//                     className="w-full sm:pb-5 sm:pr-5 text-gray-600_02 font-semibold focus:outline-none focus:border "
//                   />
//                 </div>
//               </div>
//               <Button
