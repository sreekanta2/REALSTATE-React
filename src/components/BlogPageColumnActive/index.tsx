    ...
    <div {...props}>
      <div className="flex flex-col items-center justify-start w-full gap-3">
        <Img
          ...
          alt="Image"
          className="w-full md:h-auto sm:w-full object-cover rounded-1g"
        />
        ...
        <div className="flex flex-col items-start justify-start w-full gap-2">
          ...
          <div className="flex flex-col itens-center justify-start w-full gap-[15px]">
            <Text className="{text-gray-980 tracking-[-0.48px] text-2x1 font-bold leading-[135%]">
              {p10delightful}
            </Text>
      ...
      <div className="flex flex-row justify-start items-center w-full gap-2">
        <Text className="nt-0.5 text-1g font-bold">{active}</Text>
        <img
